                    ...
                    <div className="overflow-y-auto shadow-md sm:rounded-lg h-[796px]">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4 h-80">
                            {enquiriesData.map((enquiry, index) => (
                                <div key={index} className="border border-gray-200 rounded-lg px-8 py-4 bg-gray-100 text-start">
                                    <h2 className="font-bold text-xl mb-0.5">{enquiry.customerName}</h2>
                                    <p className="text-gray-600 text-sm text-start">{enquiry.mobileNumber}</p>
                                    <p className='font-medium text-md mt-5' >No of Passengers</p>
                                    <p className='text-sm font-bold' >{enquiry.numberOfPassengers}</p>
                                </div>
                            ))}
                        </div>
                    </div>
